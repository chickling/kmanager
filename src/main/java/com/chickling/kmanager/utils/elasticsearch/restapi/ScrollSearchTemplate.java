...
public class ScrollSearchTemplate {
  ...
  public static String getScrollNextBody(String scrollId) {
    ...
    public static ElasticsearchAssistEntity getInterval(String start, String end) {
      ...
      public static String getOffset(String group, String topic, ElasticsearchAssistEntity assistEntity) {
  ...
  public static String JmxTrend(ElasticsearchAssistEntity assistEntity) {
    return "{\"size\": 0," + "  \"aggs\": {" + "    \"aggs\": {" + "      \"date_histogram\": {"
        + "        \"field\": \"timestamp\"," + "        \"interval\": \""+ assistEntity.getInterval() + "\","
        + "        \"time_zone\": \"America/Los_Angeles\"" + "      }," + "      \"aggs\": {" + "        \"metrics\": {"
        + "          \"terms\": {" + "            \"field\": \"metric\"," + "            \"size\": 0,"
        + "            \"order\": {" + "              \"_term\": \"desc\"" + "            }" + "          },"
        + "          \"aggs\": {" + "            \"brokers\": {" + "              \"terms\": {"
