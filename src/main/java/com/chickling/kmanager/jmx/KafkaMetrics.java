...
public class KafkaMetrics {
  ...
  public MeterMetric getItem(MBeanServerConnection mbsc, Optional<String> topicName, String metricName){
    return getBrokerTopicMetrics(mbsc, metricName, topicName);
  }
